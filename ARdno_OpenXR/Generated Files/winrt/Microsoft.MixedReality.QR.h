...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Microsoft::MixedReality::QR::QRVersion) consume_Microsoft_MixedReality_QR_IQRCode<D>::Version() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::TimeSpan) consume_Microsoft_MixedReality_QR_IQRCode<D>::SystemRelativeLastDetectedTime() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::DateTime) consume_Microsoft_MixedReality_QR_IQRCode<D>::LastDetectedTime() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Microsoft::MixedReality::QR::QRCode) consume_Microsoft_MixedReality_QR_IQRCodeAddedEventArgs<D>::Code() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Microsoft::MixedReality::QR::QRCode) consume_Microsoft_MixedReality_QR_IQRCodeRemovedEventArgs<D>::Code() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::MixedReality::QR::IQRCodeRemovedEventArgs)->get_Code(&value));
        return winrt::Microsoft::MixedReality::QR::QRCode{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Microsoft::MixedReality::QR::QRCode) consume_Microsoft_MixedReality_QR_IQRCodeUpdatedEventArgs<D>::Code() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::MixedReality::QR::IQRCodeUpdatedEventArgs)->get_Code(&value));
        return winrt::Microsoft::MixedReality::QR::QRCode{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::Added(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::MixedReality::QR::QRCodeWatcher, winrt::Microsoft::MixedReality::QR::QRCodeAddedEventArgs> const& handler) const
    {
        winrt::event_token token{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::MixedReality::QR::IQRCodeWatcher)->add_Added(*(void**)(&handler), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::Added_revoker consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::Added(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::MixedReality::QR::QRCodeWatcher, winrt::Microsoft::MixedReality::QR::QRCodeAddedEventArgs> const& handler) const
    {
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Microsoft::MixedReality::QR::IQRCodeWatcher)->remove_Added(impl::bind_in(token)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::Updated(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::MixedReality::QR::QRCodeWatcher, winrt::Microsoft::MixedReality::QR::QRCodeUpdatedEventArgs> const& handler) const
    {
        winrt::event_token token{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::MixedReality::QR::IQRCodeWatcher)->add_Updated(*(void**)(&handler), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::Updated_revoker consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::Updated(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::MixedReality::QR::QRCodeWatcher, winrt::Microsoft::MixedReality::QR::QRCodeUpdatedEventArgs> const& handler) const
    {
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Microsoft::MixedReality::QR::IQRCodeWatcher)->remove_Updated(impl::bind_in(token)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::Removed(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::MixedReality::QR::QRCodeWatcher, winrt::Microsoft::MixedReality::QR::QRCodeRemovedEventArgs> const& handler) const
    {
        winrt::event_token token{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::MixedReality::QR::IQRCodeWatcher)->add_Removed(*(void**)(&handler), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::Removed_revoker consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::Removed(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::MixedReality::QR::QRCodeWatcher, winrt::Microsoft::MixedReality::QR::QRCodeRemovedEventArgs> const& handler) const
    {
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Microsoft::MixedReality::QR::IQRCodeWatcher)->remove_Removed(impl::bind_in(token)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::EnumerationCompleted(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::MixedReality::QR::QRCodeWatcher, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        winrt::event_token token{};
    ...
    template <typename D> typename consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::EnumerationCompleted_revoker consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::EnumerationCompleted(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::MixedReality::QR::QRCodeWatcher, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Microsoft::MixedReality::QR::IQRCodeWatcher)->remove_EnumerationCompleted(impl::bind_in(token)));
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Microsoft::MixedReality::QR::QRCode>) consume_Microsoft_MixedReality_QR_IQRCodeWatcher<D>::GetList() const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::MixedReality::QR::QRCodeWatcherAccessStatus>) consume_Microsoft_MixedReality_QR_IQRCodeWatcherStatics<D>::RequestAccessAsync() const
    {
        void* operation{};
